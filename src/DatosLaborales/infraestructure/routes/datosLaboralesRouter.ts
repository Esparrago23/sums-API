...
router.post('/datos_laborales', authMiddleware(), validate(datosLaboralesSchema), createDatosLaboralesController.run.bind(createDatosLaboralesController));
router.get('/datos_laborales', authMiddleware(), readAllDatosLaboralesController.run.bind(readAllDatosLaboralesController));
router.delete('/datos_laborales/:id', authMiddleware(), deleteDatosLaboralesController.run.bind(deleteDatosLaboralesController));
router.get('/datos_laborales/:id', authMiddleware(), readDatosLaboralesByIdController.run.bind(readDatosLaboralesByIdController));
router.put('/datos_laborales/:id', authMiddleware(), validate(datosLaboralesSchema), updateDatosLaboralesController.run.bind(updateDatosLaboralesController));
