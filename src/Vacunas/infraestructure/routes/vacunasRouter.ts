...
router.post('/vacunas', authMiddleware(), validate(vacunasSchema), createVacunasController.run.bind(createVacunasController));
router.get('/vacunas', authMiddleware(), readAllVacunasController.run.bind(readAllVacunasController));
router.delete('/vacunas/:id', authMiddleware(), deleteVacunasController.run.bind(deleteVacunasController));
router.get('/vacunas/:id', authMiddleware(), readVacunasByIdController.run.bind(readVacunasByIdController));
router.put('/vacunas/:id', authMiddleware(), validate(vacunasSchema), updateVacunasController.run.bind(updateVacunasController));
